...
/**
 * Name:解析二维码图片。一维条码、二维码各种类型简介 https://blog.csdn.net/xdg_blog/article/details/52932707
 * <p>
...
//        ALL_HINT_MAP.put(DecodeHintType.PURE_BARCODE, Boolean.TRUE);
    ...
    public static String syncDecodeQRCode(String picturePath) {
        return syncDecodeQRCode(WstQRCodeUtils.getDecodeAbleBitmap(picturePath));
    }
